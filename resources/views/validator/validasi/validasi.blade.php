                    ...
                    @if (session('warning'))
                        <div id="alert" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            ...
                            <span id="close-btn" class="absolute top-0 bottom-0 right-0 px-4 py-3">
                                <svg class="fill-current h-6 w-6 text-red-500 cursor-pointer"
                                        ...
                                        <tbody>
                                            @foreach ($knowledges_queue->where('status', 0) as $knowledge)
                                                <tr class="border-b border-neutral-200 dark:border-white/10">
                                                    ...
                                                    <td> {{ strlen($knowledge->description) > 50 ? substr($knowledge->description, 0, 50) . '...' : $knowledge->description }}
                                                    </td>
                                                    ...
                                                    <td class="whitespace-nowrap py-2 flex justify-end">
                                                        ...
                                                        <form
                                                            action="{{ route('validasiknowledge.retrieve', $knowledge->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit"
                            ...
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <table class="min-w-full text-left text-sm font-light text-surface dark:text-white">
                                        ...
                                        <tbody>
                                            @foreach ($knowledges_checked as $knowledge)
                                                <tr class="border-b border-neutral-200 dark:border-white/10">
                                                    <td class="whitespace-nowrap px-6 py-4">{{ $knowledge->name }}</td>
                                                    <td> {{ strlen($knowledge->description) > 50 ? substr($knowledge->description, 0, 50) . '...' : $knowledge->description }}
                                                    </td>
                                                    ...
                                                    <td class="whitespace-nowrap py-2 flex justify-end">
                                                        ...
                                                        <form
                                                            action="{{ route('validasiknowledge.approve', $knowledge->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit"
                                                        ...
                                                        <form
                                                            action="{{ route('validasiknowledge.reject', $knowledge->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit"
                                                        ...
                                                        <form
                                                            action="{{ route('validasiknowledge.cancel', $knowledge->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit"
                            ...
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <table class="min-w-full text-left text-sm font-light text-surface dark:text-white">
                                        ...
                                        <tbody>
                                            @foreach ($knowledges_approved as $knowledge)
                                                <tr class="border-b border-neutral-200 dark:border-white/10">
                                                    <td class="whitespace-nowrap px-6 py-4">{{ $knowledge->name }}</td>
                                                    <td> {{ strlen($knowledge->description) > 50 ? substr($knowledge->description, 0, 50) . '...' : $knowledge->description }}
                                                    </td>
                            ...
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden">
                                    <table class="min-w-full text-left text-sm font-light text-surface dark:text-white">
                                        ...
                                        <tbody>
                                            @foreach ($knowledges_rejected as $knowledge)
                                                <tr class="border-b border-neutral-200 dark:border-white/10">
                                                    <td class="whitespace-nowrap px-6 py-4">{{ $knowledge->name }}</td>
                                                    <td> {{ strlen($knowledge->description) > 50 ? substr($knowledge->description, 0, 50) . '...' : $knowledge->description }}
                                                    </td>
