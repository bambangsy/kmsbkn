       ...
       <a data-toggle="tooltip"
          ...
          href="student-take-quiz.html"><span class="material-icons">hourglass_empty</span></a>
            ...
            <form action="{{ route('user.pelatihan.enroll', $course->id) }}" method="POST">
                @csrf
                <button type="submit" class="bg-white px-5 py-3 ml-2 rounded-md text-black shadow-sm hover:bg-gray-300">
                    Enroll
                </button>
            </form>
        </div>
                ...
                <li class="nav-item navbar-list__item">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body">
                            Dibuat oleh: <a class="card-title m-0" href="">{{ $course->user->name }}</a>
